// ============================================================
//  REGISTRAR SALIDA — Agregar/Quitar productos y calcular total
// ============================================================
document.addEventListener('DOMContentLoaded', () => {

    const btnAgregar = document.getElementById('btn-agregar-salida');
    if (!btnAgregar) return;

    btnAgregar.addEventListener('click', () => {
        const select  = document.getElementById('select-prod-salida');
        const opt     = select.options[select.selectedIndex];
        const tbody   = document.getElementById('tabla-detalles-salida');
        ...
        const cantidad = parseInt(document.getElementById('cantidad-prod-salida').value);
        ...
        document.getElementById('cantidad-prod-salida').value = 1;
    });
